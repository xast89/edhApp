...
public class CardRepository
{
    ...
    private List<Card> createDereviDeck()
    {
        ...
        dereviDeckTemp.add(createCard("Trailblazer's Boots", "trailblazersBoots", "cards/colorless/artifact/trailblazer'sBoots.jpg"));
        dereviDeckTemp.add(createCard("Opportunity", "opportunity", "cards/blue/instant/opportunity.jpg"));
        dereviDeckTemp.add(createCard("Jace's Ingenuity", "jacesIngenuity", "cards/blue/instant/jace'sIngenuity.jpg"));
        ...
        dereviDeckTemp.add(createCard("Kodama's Reach", "kodamasReach", "cards/green/sorcery/kodama'sReach.jpg"));
        dereviDeckTemp.add(createCard("Day's Undoing", "daysUndoing", "cards/blue/sorcery/day'sUndoing.jpg"));
        ...
        dereviDeckTemp.add(createCard("Duelist's Heritage", "duelistsHeritage", "cards/white/enchantment/duelist'sHeritage.jpg"));
        dereviDeckTemp.add(createCard("Kaseto, Orochi Archmage", "kasetoOrochiArchmage", "cards/multi/creature/kaseto,OrochiArchmage.jpg"));
        ...
        dereviDeckTemp.add(createCard("Conqueror's Flail", "conquerorsFlail", "cards/colorless/artifact/conqueror'sFlail.jpg"));
        dereviDeckTemp.add(createCard("Plains", "plains_3", "cards/land/plains.jpg"));
         ...
         dereviDeckTemp.add(createCard("Life's Legacy", "lifesLegacy", "cards/green/sorcery/life'sLegacy.jpg"));
