...
public class CardRepository {
    ...
    private void createDereviDeck() {
        ...
        dereviDeck.add(createCard("Plains", "132"));
        dereviDeck.add(createCard("Fool's Demise", "111"));
        dereviDeck.add(createCard("Seal of Removal", "42"));
        dereviDeck.add(createCard("Civic Saber ", "227"));
        dereviDeck.add(createCard("Rancor", "76"));
        dereviDeck.add(createCard("Sylvan Caryatid", "180"));
